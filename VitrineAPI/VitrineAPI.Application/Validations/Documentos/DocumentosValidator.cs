namespace VitrineAPI.Application.Validations.Documentos
{
    public static class CpfValidacao
    {
        ...
        {
            string cpfNumeros = Utils.ApenasNumeros(cpf);
    ...
    public static class CnpjValidacao
    {
        ...
        {
            string cnpjNumeros = Utils.ApenasNumeros(cpnj);
    ...
    public class DigitoVerificador
    {
        ...
        private string GetDigitSum()
        {
            ...
            {
                int produto = (int)char.GetNumericValue(_numero[i]) * _multiplicadores[m];
                soma += produto;
            ...
            int mod = (soma % Modulo);
            int resultado = _complementarDoModulo ? Modulo - mod : mod;
